...
Some results are presented in figure~\ref{fig:results} where we can see the decrease in noise compare to the regular path tracing. We computed the mean square error value for different scenes that are presented in table~\ref{tab:timing}

...
\caption{\label{fig:results}Same scene using the classical path tracing (image $a$) or our method (image $b$). Images $c$ and $d$ are both details of respectivelly images $a$ and $b$ }
\end{center}
\end{figure}

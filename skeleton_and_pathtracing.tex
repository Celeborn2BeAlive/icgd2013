...
For the same reason, we say that the output of Alg.~\ref{algo::3d_curvskel} is a \myem{curvilinear skeleton}. In Sec.~\ref{sec::appli_pathtrace}, the outputs of Alg.~\ref{algo::3d_curvskel} were always one dimensional complexes.

...
A CHANGER : INTRODUIRE L'EQUATION DU RENDU : du genre : for each pixel we seek the intersection point. At this point, to obtain the luminosity, we must solve the rendering equation. The rendering equation is a recursive integral equation. The integrand of the equation contains the radiance function that we must compute:
...
\end{align*}
INTRODUIRE BRIEVEMENT la luminance du style : L being the light flux from point $x$ toward direction $\Theta$.

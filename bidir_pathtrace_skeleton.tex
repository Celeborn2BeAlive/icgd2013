...
\begin{center}
\begin{tabular}{ccc}
	\myincludegraphics{0.3\textwidth}{EPS/mario_life1}{.pdf} &
	\myincludegraphics{0.3\textwidth}{EPS/mario_life2}{.pdf} &
	\myincludegraphics{0.3\textwidth}{EPS/mario_life3}{.pdf} \\
	a) A complex $X$ & b) $ParDirCollapse(X,\emptyset,1)$ & c) $ParDirCollapse(X,\emptyset,2)$\\
	\myincludegraphics{0.3\textwidth}{EPS/mario_life4}{.pdf} &
	\myincludegraphics{0.3\textwidth}{EPS/mario_life5}{.pdf} &
	\myincludegraphics{0.3\textwidth}{EPS/mario_life6}{.pdf} \\
	d) $ParDirCollapse(X,\emptyset,3)$ & e) $ParDirCollapse(X,\emptyset,4)$ & f) $ParDirCollapse(X,\emptyset,5)$\\
\end{tabular}
\caption[Computing the lifespan of a face]{\label{fig:lifespan_exemple} \textbf{Computing the lifespan of a face - }Let $e$ be the edge of the complex $X$, pointed out by a red arrow on \textbf{a}. Two iterations of $ParDirCollapse$ algorithm are necessary before $e$ becomes a facet, as depicted on \textbf{c}. Therefore, $\birth{e}{X}=2$. Five iterations of $ParDirCollapse$ algorithm are necessary for removing $e$ from the complex, as depicted in \textbf{f}. Therefore, $\death{e}{X}=5$. We have $\lifespan{e}{X}=3$.}
\end{center}
\end{figure}
